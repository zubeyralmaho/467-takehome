"""Entry point for Q4 machine translation."""
...
from src.q4_machine_translation.train import run_training


def parse_args() -> argparse.Namespace:
    parser = argparse.ArgumentParser(description="Run Q4 machine-translation baselines.")
