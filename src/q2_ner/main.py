"""Entry point for Q2 named entity recognition."""
...
from src.q2_ner.train import run_training


def parse_args() -> argparse.Namespace:
    parser = argparse.ArgumentParser(description="Run Q2 named entity recognition baselines.")
