"""Entry point for Q3 summarization."""
...
from src.q3_summarization.train import run_training


def parse_args() -> argparse.Namespace:
    parser = argparse.ArgumentParser(description="Run Q3 summarization baselines.")
