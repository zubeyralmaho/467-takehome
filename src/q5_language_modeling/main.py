"""Entry point for Q5 language modeling."""
...
from src.q5_language_modeling.train import run_training


def parse_args() -> argparse.Namespace:
    parser = argparse.ArgumentParser(description="Run Q5 language modeling baselines.")
    ...
    parser.add_argument(
        "--final-eval",
        action="store_true",
        help="Also evaluate on the held-out test split and export generation samples.",
    )
