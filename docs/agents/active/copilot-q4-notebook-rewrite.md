...
1. Rewrite the remaining Q4 notebook cells so they track explicit run directories, build the Q4 summary artifact, refresh the report figure, and remove the stale duplicate legacy block.
